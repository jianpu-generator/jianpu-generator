...
impl Default for MetadataDefaultsOut {
    fn default() -> Self {
        ...
        MetadataDefaultsOut {
            ...
            notes_horizontal_padding_pt: DEFAULT_NOTES_HORIZONTAL_PADDING_PT,
            chords_horizontal_padding_pt: DEFAULT_CHORDS_HORIZONTAL_PADDING_PT,
            lyrics_horizontal_padding_pt: DEFAULT_LYRICS_HORIZONTAL_PADDING_PT,
            note_dash_horizontal_padding_pt: DEFAULT_NOTE_DASH_HORIZONTAL_PADDING_PT,
