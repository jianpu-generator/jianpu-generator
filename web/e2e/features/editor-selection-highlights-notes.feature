Feature: Editor selection highlights notes
  ...
  Scenario: Selecting a measure line in the editor highlights its notes in the preview
    ...
    Then 2 notes are drag-selected, as seen in editor selection highlights notes
    ...
    Then 0 notes are drag-selected, as seen in editor selection highlights notes
