...
import { writeStoredSyncedShareGithubAuth } from './syncedShareGithubAuth'
import {
...
} from './syncedShareGithubAuthPopup'

/**
 * Completes the popup half of Synced Share's "sign in with GitHub" flow --
 * see `syncedShareGithubAuthPopup.ts`'s doc comment for the flow this
 * finishes.
 */
