 ...
 * own `window.close()`) lives in `./syncedShareGithubAuthCallback.ts`.
 ...
 * `syncedShareGithubAuthCallback.ts` can send the matching message. */
 ...
 * `syncedShareGithubAuthCallback.ts`) requires `window.opener` to still be
