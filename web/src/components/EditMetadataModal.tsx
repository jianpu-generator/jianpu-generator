                ...
                <tr>
                  ...
                  <td style={tdStyle}>
                    <input
                      type="number"
                      min="1"
                      placeholder={defaults ? String(defaults.rowHeight) : undefined}
                      style={inputStyle}
                ...
                <tr>
                  ...
                  <td style={tdStyle}>
                    <input
                      ...
                      min="1"
                      placeholder={
                        defaults ? String(defaults.maxMeasuresPerSystem) : undefined
                      }
                      style={inputStyle}
                ...
                <tr>
                  ...
                  <td style={tdStyle}>
                    <input
                      type="number"
                      min="1"
                      placeholder={defaults ? String(defaults.labelWidth) : undefined}
                      style={inputStyle}
